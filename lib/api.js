...
export async function uploadMenuImage(restaurantSlug, file) {
  ...
  // Cloudinary URLs already start with https:// and are ready to use as-is —
// only add our own server's address in front of it for the old local-disk
// style of path (a safety net in case any old images still use that format).
